...
#ifdef HORDE
const Score BHordeBonus[][RANK_NB][int(FILE_NB) / 2] = {
	{},
	{ // Black Pawn
		{ S(0, 0), S(0, 0), S(0, 0), S(0, 0) },
		{ S(-19, 5), S(4, 4), S(7, 8), S(-10,-2) },
		{ S(20,-6), S(10,-5), S(18, 5), S(50, 4) },
		{ S(40, 1), S(-14, 3), S(-16,-8), S(-18, -3) },
		{ S(10, 6), S(-16, 9), S(-18, 7), S(-20,-6) },
		{ S(8, 6), S(-18,-5), S(-20, 2), S(-20, 4) },
		{ S(8, 1), S(8,-9), S(8, 1), S(8,18) },
		{ S(0, 0), S(0, 0), S(0, 0), S(0, 0) }
	},
	{ // Black Knights are strong on b6 and g6 in horde for sacking on a4 or h4
		{ S(-143, -97), S(-96,-82), S(-80,-46), S(-73,-14) }, //1
		{ S(-60, -69), S(0,-55), S(15,-17), S(50,  9) },
		{ S(10, -50), S(100,-39), S(0, -8), S(9, 28) },
		{ S(0, -41), S(-5,-25), S(-40,  7), S(-50, 38) },
		{ S(20, -46), S(-5,-25), S(-50,  2), S(-70, 41) },
		{ S(15, -55), S(100,-38), S(-40, -8), S(-50, 27) },
		{ S(20, -64), S(0,-50), S(5,-24), S(14, 13) },
		{ S(-195,-110), S(-66,-90), S(-42,-50), S(-29,-13) }
	},
	{ // Black Bishop
		{ S(-54,-68), S(-23,-40), S(-35,-46), S(-44,-28) },
	...
	{ // Black Rook
		...
		{ S(60, 0), S(30, 0), S(25, 0), S(25, 0) },
		{ S(80, 0), S(40, 0), S(40, 0), S(40, 0) },
		{ S(110, 0), S(110, 0), S(110, 0), S(110, 0) },
		{ S(160, 0), S(160, 0), S(160, 0), S(160, 0) }
	},
	{ // Black Queen
		{ S(20,-70), S(-3,-57), S(-4,-41), S(-1,-29) },
		{ S(20,-58), S(6,-30), S(9,-21), S(8, -4) },
		{ S(20, 45), S(10, 45), S(10, 45), S(10, 45) },
		{ S(65, 45), S(40, 45), S(40, 45), S(40, 45) },
		{ S(90, 45), S(80, 45), S(80, 45), S(80, 45), },
		{ S(100, 45), S(95, 45), S(90,-11), S(80,  3) },
		{ S(110, 45), S(100, 45), S(110, 45), S(110, 45) },
		{ S(120, 50), S(120, 50), S(120, 50), S(120, 50) }
	},
	{ // Black King
		{ S(291, 28), S(344, 76), S(294,103), S(219,112) },
		{ S(289, 70), S(329,119), S(263,170), S(205,159) },
...
const Score WHordeBonus[][RANK_NB][int(FILE_NB) / 2] = {
	{},
	{ // Pawn
		{ S(-5, -5), S(-5, -5), S(-5, -5), S(-5, -5) },
		{ S(0,-10), S(0,-10), S(0, -10), S(0,-10) },
		{ S(10, 0), S(20,0), S(20, 0), S(20, 0) },
		{ S(30, 25), S(30, 25), S(30,25), S(30,25) },
		{ S(30, 50), S(40, 50), S(40, 50), S(40,50) },
		{ S(65, 50), S(75 ,50), S(75, 50), S(75, 50) },
		{ S(200, 200), S(150, 150), S(150, 150), S(150, 150) },
		{ S(0, 0), S(0, 0), S(0, 0), S(0, 0) }
	},
	{ // Knight
		{ S(-143, -97), S(-96,-82), S(-80,-46), S(-73,-14) },
...
Score hpsq[COLOR_NB][PIECE_TYPE_NB][SQUARE_NB];
...
void init() {
  ...
  {
#ifdef HORDE  
	  Score hv = make_score(HordeValue[MG][pt], HordeValue[EG][pt]);
#endif
...
#ifdef HORDE
		  hpsq[WHITE][pt][s] = hv + WHordeBonus[pt][rank_of(s)][edgeDistance];
		  hpsq[BLACK][pt][~s] = -(hv + BHordeBonus[pt][rank_of(s)][edgeDistance]);
#endif
      }
  }
}
